...
Partial Public Class Database1DataSet
    ...
    Partial Public Class PelangganDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddPelangganRow(ByVal nama As String, ByVal status As String, ByVal harga As Integer, ByVal jumlah_sewa As Integer, ByVal diskon As Integer, ByVal jumlah_bayar As Integer, ByVal total_bayar As Integer) As PelangganRow
            Dim rowPelangganRow As PelangganRow = CType(Me.NewRow,PelangganRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, nama, status, harga, jumlah_sewa, diskon, jumlah_bayar, total_bayar}
    ...
    Partial Public Class PelangganRow
        ...
        Public Property status() As String
            Get
                Try 
                    Return CType(Me(Me.tablePelanggan.statusColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'status' in table 'Pelanggan' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablePelanggan.statusColumn) = value
            End Set
        End Property
        ...
        Public Property jumlah_sewa() As Integer
            Get
                Try 
                    Return CType(Me(Me.tablePelanggan.jumlah_sewaColumn),Integer)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'jumlah_sewa' in table 'Pelanggan' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablePelanggan.jumlah_sewaColumn) = value
            End Set
        End Property
        ...
        Public Function IsstatusNull() As Boolean
            Return Me.IsNull(Me.tablePelanggan.statusColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub SetstatusNull()
            Me(Me.tablePelanggan.statusColumn) = Global.System.Convert.DBNull
        End Sub
        ...
        Public Function Isjumlah_sewaNull() As Boolean
            Return Me.IsNull(Me.tablePelanggan.jumlah_sewaColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub Setjumlah_sewaNull()
            Me(Me.tablePelanggan.jumlah_sewaColumn) = Global.System.Convert.DBNull
        End Sub
    ...
    Partial Public Class PelangganTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Pelanggan] WHERE (([Id] = @Original_Id) AND ((@IsNull_nama = 1"& _ 
                " AND [nama] IS NULL) OR ([nama] = @Original_nama)) AND ((@IsNull_status = 1 AND "& _ 
                "[status] IS NULL) OR ([status] = @Original_status)) AND ((@IsNull_harga = 1 AND "& _ 
                "[harga] IS NULL) OR ([harga] = @Original_harga)) AND ((@IsNull_jumlah_sewa = 1 A"& _ 
                "ND [jumlah_sewa] IS NULL) OR ([jumlah_sewa] = @Original_jumlah_sewa)) AND ((@IsN"& _ 
                "ull_diskon = 1 AND [diskon] IS NULL) OR ([diskon] = @Original_diskon)) AND ((@Is"& _ 
                "Null_jumlah_bayar = 1 AND [jumlah_bayar] IS NULL) OR ([jumlah_bayar] = @Original"& _ 
                "_jumlah_bayar)) AND ((@IsNull_total_bayar = 1 AND [total_bayar] IS NULL) OR ([to"& _ 
                "tal_bayar] = @Original_total_bayar)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Pelanggan] ([Id], [nama], [status], [harga], [jumlah_sewa], [d"& _ 
                "iskon], [jumlah_bayar], [total_bayar]) VALUES (@Id, @nama, @status, @harga, @jum"& _ 
                "lah_sewa, @diskon, @jumlah_bayar, @total_bayar);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, nama, status, harga"& _ 
                ", jumlah_sewa, diskon, jumlah_bayar, total_bayar FROM Pelanggan WHERE (Id = @Id)"& _ 
                ""
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Pelanggan] SET [Id] = @Id, [nama] = @nama, [status] = @status, [har"& _ 
                "ga] = @harga, [jumlah_sewa] = @jumlah_sewa, [diskon] = @diskon, [jumlah_bayar] ="& _ 
                " @jumlah_bayar, [total_bayar] = @total_bayar WHERE (([Id] = @Original_Id) AND (("& _ 
                "@IsNull_nama = 1 AND [nama] IS NULL) OR ([nama] = @Original_nama)) AND ((@IsNull"& _ 
                "_status = 1 AND [status] IS NULL) OR ([status] = @Original_status)) AND ((@IsNul"& _ 
                "l_harga = 1 AND [harga] IS NULL) OR ([harga] = @Original_harga)) AND ((@IsNull_j"& _ 
                "umlah_sewa = 1 AND [jumlah_sewa] IS NULL) OR ([jumlah_sewa] = @Original_jumlah_s"& _ 
                "ewa)) AND ((@IsNull_diskon = 1 AND [diskon] IS NULL) OR ([diskon] = @Original_di"& _ 
                "skon)) AND ((@IsNull_jumlah_bayar = 1 AND [jumlah_bayar] IS NULL) OR ([jumlah_ba"& _ 
                "yar] = @Original_jumlah_bayar)) AND ((@IsNull_total_bayar = 1 AND [total_bayar] "& _ 
                "IS NULL) OR ([total_bayar] = @Original_total_bayar)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, nama, status,"& _ 
                " harga, jumlah_sewa, diskon, jumlah_bayar, total_bayar FROM Pelanggan WHERE (Id "& _ 
                "= @Id)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, nama, status, harga, jumlah_sewa, diskon, jumlah_bayar, total_bayar FR"& _ 
                "OM dbo.Pelanggan"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Id As Integer, ByVal Original_nama As String, ByVal Original_status As String, ByVal Original_harga As Global.System.Nullable(Of Integer), ByVal Original_jumlah_sewa As Global.System.Nullable(Of Integer), ByVal Original_diskon As Global.System.Nullable(Of Integer), ByVal Original_jumlah_bayar As Global.System.Nullable(Of Integer), ByVal Original_total_bayar As Global.System.Nullable(Of Integer)) As Integer
            ...
            If (Original_jumlah_sewa.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(8).Value = CType(Original_jumlah_sewa.Value,Integer)
            Else
            ...
            If (Original_jumlah_bayar.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(12).Value = CType(Original_jumlah_bayar.Value,Integer)
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal Id As Integer, ByVal nama As String, ByVal status As String, ByVal harga As Global.System.Nullable(Of Integer), ByVal jumlah_sewa As Global.System.Nullable(Of Integer), ByVal diskon As Global.System.Nullable(Of Integer), ByVal jumlah_bayar As Global.System.Nullable(Of Integer), ByVal total_bayar As Global.System.Nullable(Of Integer)) As Integer
            ...
            If (jumlah_sewa.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(4).Value = CType(jumlah_sewa.Value,Integer)
            Else
            ...
            If (jumlah_bayar.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(6).Value = CType(jumlah_bayar.Value,Integer)
            Else
        ...
        Public Overloads Overridable Function Update( _
            ...
            End If
            If (jumlah_sewa.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(jumlah_sewa.Value,Integer)
            Else
            ...
            End If
            If (jumlah_bayar.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(6).Value = CType(jumlah_bayar.Value,Integer)
            Else
            ...
            If (Original_jumlah_sewa.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(16).Value = CType(Original_jumlah_sewa.Value,Integer)
            Else
            ...
            If (Original_diskon.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(18).Value = CType(Original_diskon.Value,Integer)
            Else
            ...
            If (Original_jumlah_bayar.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(20).Value = CType(Original_jumlah_bayar.Value,Integer)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal nama As String, ByVal status As String, ByVal harga As Global.System.Nullable(Of Integer), ByVal jumlah_sewa As Global.System.Nullable(Of Integer), ByVal diskon As Global.System.Nullable(Of Integer), ByVal jumlah_bayar As Global.System.Nullable(Of Integer), ByVal total_bayar As Global.System.Nullable(Of Integer), ByVal Original_Id As Integer, ByVal Original_nama As String, ByVal Original_status As String, ByVal Original_harga As Global.System.Nullable(Of Integer), ByVal Original_jumlah_sewa As Global.System.Nullable(Of Integer), ByVal Original_diskon As Global.System.Nullable(Of Integer), ByVal Original_jumlah_bayar As Global.System.Nullable(Of Integer), ByVal Original_total_bayar As Global.System.Nullable(Of Integer)) As Integer
            Return Me.Update(Original_Id, nama, status, harga, jumlah_sewa, diskon, jumlah_bayar, total_bayar, Original_Id, Original_nama, Original_status, Original_harga, Original_jumlah_sewa, Original_diskon, Original_jumlah_bayar, Original_total_bayar)
        End Function
    End Class
