...
Partial Public Class DatabaseDataSet
    ...
    Partial Public Class StudentDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddStudentRow(ByVal Id As Integer, ByVal nim As String, ByVal name As String, ByVal address As String, ByVal major As String, ByVal concentration As String) As StudentRow
            Dim rowStudentRow As StudentRow = CType(Me.NewRow,StudentRow)
            Dim columnValuesArray() As Object = New Object() {Id, nim, name, address, major, concentration}
        ...
        Private Sub InitClass()
            ...
            Me.columnconcentration.MaxLength = 10
        End Sub
    ...
    Partial Public Class StudentRow
        ...
        Public Property concentration() As String
            Get
                Try 
                    Return CType(Me(Me.tableStudent.concentrationColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'concentration' in table 'Student' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableStudent.concentrationColumn) = value
            End Set
        End Property
        ...
        Public Function IsconcentrationNull() As Boolean
            Return Me.IsNull(Me.tableStudent.concentrationColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub SetconcentrationNull()
            Me(Me.tableStudent.concentrationColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
    ...
    Partial Public Class StudentTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Student] WHERE (([Id] = @Original_Id) AND ((@IsNull_nim = 1 AN"& _ 
                "D [nim] IS NULL) OR ([nim] = @Original_nim)) AND ((@IsNull_name = 1 AND [name] I"& _ 
                "S NULL) OR ([name] = @Original_name)) AND ((@IsNull_address = 1 AND [address] IS"& _ 
                " NULL) OR ([address] = @Original_address)) AND ((@IsNull_major = 1 AND [major] I"& _ 
                "S NULL) OR ([major] = @Original_major)) AND ((@IsNull_concentration = 1 AND [con"& _ 
                "centration] IS NULL) OR ([concentration] = @Original_concentration)))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_major", Global.System.Data.SqlDbType.NChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "major", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_concentration", Global.System.Data.SqlDbType.NChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "concentration", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([Id], [nim], [name], [address], [major], [concentrat"& _ 
                "ion]) VALUES (@Id, @nim, @name, @address, @major, @concentration);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, n"& _ 
                "im, name, address, major, concentration FROM Student WHERE (Id = @Id)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@major", Global.System.Data.SqlDbType.NChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "major", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@concentration", Global.System.Data.SqlDbType.NChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "concentration", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._adapter.UpdateCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Student] SET [Id] = @Id, [nim] = @nim, [name] = @name, [address] = "& _ 
                "@address, [major] = @major, [concentration] = @concentration WHERE (([Id] = @Ori"& _ 
                "ginal_Id) AND ((@IsNull_nim = 1 AND [nim] IS NULL) OR ([nim] = @Original_nim)) A"& _ 
                ...
                " ((@IsNull_major = 1 AND [major] IS NULL) OR ([major] = @Original_major)) AND (("& _ 
                "@IsNull_concentration = 1 AND [concentration] IS NULL) OR ([concentration] = @Or"& _ 
                "iginal_concentration)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, nim, name, address, major, concentration FR"& _ 
                "OM Student WHERE (Id = @Id)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@major", Global.System.Data.SqlDbType.NChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "major", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@concentration", Global.System.Data.SqlDbType.NChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "concentration", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_major", Global.System.Data.SqlDbType.NChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "major", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_concentration", Global.System.Data.SqlDbType.NChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "concentration", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, nim, name, address, major, concentration FROM dbo.Student"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Id As Integer, ByVal Original_nim As String, ByVal Original_name As String, ByVal Original_address As String, ByVal Original_major As String, ByVal Original_concentration As String) As Integer
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(10).Value = CType(Original_concentration,String)
            End If
        ...
        Public Overloads Overridable Function Insert(ByVal Id As Integer, ByVal nim As String, ByVal name As String, ByVal address As String, ByVal major As String, ByVal concentration As String) As Integer
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(5).Value = CType(concentration,String)
            End If
        ...
        Public Overloads Overridable Function Update(ByVal Id As Integer, ByVal nim As String, ByVal name As String, ByVal address As String, ByVal major As String, ByVal concentration As String, ByVal Original_Id As Integer, ByVal Original_nim As String, ByVal Original_name As String, ByVal Original_address As String, ByVal Original_major As String, ByVal Original_concentration As String) As Integer
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(concentration,String)
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(14).Value = CType(Original_major,String)
            End If
            If (Original_concentration Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(16).Value = CType(Original_concentration,String)
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal nim As String, ByVal name As String, ByVal address As String, ByVal major As String, ByVal concentration As String, ByVal Original_Id As Integer, ByVal Original_nim As String, ByVal Original_name As String, ByVal Original_address As String, ByVal Original_major As String, ByVal Original_concentration As String) As Integer
            Return Me.Update(Original_Id, nim, name, address, major, concentration, Original_Id, Original_nim, Original_name, Original_address, Original_major, Original_concentration)
        End Function
    End Class
